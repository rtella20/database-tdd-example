...
public class TestsRecord extends UpdatableRecordImpl<TestsRecord> implements Record4<UUID, String, String, String> {

    private static final long serialVersionUID = -882320869;
     ...
     */
    @Override
    public TestsRecord values(UUID value1, String value2, String value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TestsRecord(UUID id, String name, String test, String expected) {
        super(Tests.TESTS);
